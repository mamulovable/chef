      ...
      <section className="py-20 bg-gradient-to-r from-primary to-accent text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <button className="border border-white text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white hover:text-primary transition-colors">
              Browse Categories
            </button>
          </div>
            ...
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-8">
                <div className="flex items-center mb-4">
                  <span className="bg-primary text-white px-3 py-1 rounded-full text-sm font-semibold">Technology</span>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">DevOps</a></li>
      ...
      <div className="text-center">
        <Authenticated>
          ...
          <p className="text-sm text-gray-500">
            Ready to write and publish your next article.
          </p>
        </Authenticated>
        <Unauthenticated>
          <p className="text-lg text-gray-600 mb-4">Sign in to start writing</p>
          <p className="text-sm text-gray-500">
            Create your account to publish articles
          </p>
        </Unauthenticated>
      </div>
