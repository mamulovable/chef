            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <button className="text-primary hover:text-primary-hover font-semibold">Live Demo</button>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <form className="space-y-6">
                <div>
                  <input type="text" placeholder="Your Name" className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-primary" />
                </div>
                <div>
                  <input type="email" placeholder="Your Email" className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-primary" />
                </div>
                <div>
                  <textarea rows={4} placeholder="Your Message" className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-primary"></textarea>
                </div>
      ...
      <div className="text-center">
        <Authenticated>
          ...
          <p className="text-sm text-gray-500">
            Ready to showcase your work and connect with clients.
          </p>
        </Authenticated>
        <Unauthenticated>
          <p className="text-lg text-gray-600 mb-4">Sign in to manage your portfolio</p>
          <p className="text-sm text-gray-500">
