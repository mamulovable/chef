          ...
          <div className="text-center">
            <div>
              ...
              <p className="my-2">
                ...
                in ways that require a browser that supports cross-origin isolation. Start dreaming with desktop Chrome or
                Firefox!
              </p>
            </div>
          </div>
          ...
          <div>
            {experience === 'marketing-page-only-for-mobile' ? (
              <>
                ...
                <p className="my-2">Dreamera supports desktop Firefox, Chrome, and some other Chromium-based browsers.</p>
              </>
            ) : experience === 'marketing-page-only-for-desktop-safari' ? (
              <>
                <h3 className="text-xl font-bold">You're a few keystrokes away from building with Dreamera!</h3>
                <p className="my-2">
                  Dreamera uses{' '}
                  <a
                    href="https://webcontainers.io/guides/browser-support#web-platform-requirements"
