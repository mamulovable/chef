...
- [-] 1. Update type definitions for OpenRouter provider
...
- [ ] 2. Extend API key storage schema for OpenRouter
...
- [ ] 3. Implement OpenRouter model configuration
...
- [ ] 4. Implement OpenRouter provider in getProvider function
...
- [ ] 5. Add OpenRouter-specific error handling
...
- [ ] 6. Create unit tests for OpenRouter provider
...
- [ ] 7. Add OpenRouter to usage annotation system
...
- [ ] 8. Test OpenRouter integration end-to-end
